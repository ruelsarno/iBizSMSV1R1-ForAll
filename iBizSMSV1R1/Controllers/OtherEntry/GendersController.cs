...
namespace iBizSMSV1R1.Controllers.OtherEntry
{
    ...
    public class GendersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("recno,genders")] Gender gender)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("recno,genders")] Gender gender)
        {
            if (id != gender.recno)
            {
                return NotFound();
        ...
        {
            return _context.Gender.Any(e => e.recno == id);
        }
    }
}
